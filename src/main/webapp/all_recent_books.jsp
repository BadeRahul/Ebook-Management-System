			...
			<div class="col-md-3">
				<div class="card mt-4 crd-ho border border-primary">
					<div class="card-body text-center">
						...
						%>
						<div class="row justify-content-center">
							<a href="cart?bid=<%=b.getBookId()%>&&uid=<%=u.getId() %>" class="btn btn-outline-warning btn-sm"><i class="fa-solid fa-cart-plus"></i> Add Cart</a> <a href="view_book.jsp?bid=<%=b.getBookId() %>"
