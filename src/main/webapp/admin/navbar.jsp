	...
	<div class="row">
		...
		<div class="col-md-6 text-right ml-auto">
			<c:if test="${not empty userobj }">
				...
				<a  data-toggle="modal" data-target="#exampleModalCenter" class="btn btn-danger text-white"><i class="fa-solid fa-right-to-bracket"></i> LogOut</a>
			</c:if>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<!-- <form class="form-inline my-2 my-lg-0">
			...
			<button class="btn btn-light my-2 my-sm-0 " type="submit"><i class="fa-solid fa-wrench"></i>
			Settings</button>
